...
public class StartPanel extends JPanel
{
    ...
    {
        super();
        this.sickoButton = new JButton("Sicko Mode!");
        this.controller = controller;
        this.panelLayout = new SpringLayout();
        this.typeGroup = new ButtonGroup();
        this.celebrityRadio = new JRadioButton("Celebrity");
        this.literatureRadio = new JRadioButton("Football Celebrity");
        this.celebrityClue = "Enter the clue for the celebrity";
        this.literatureClue = "Enter the player's position and team, then seperated by commas other the hint";
    ...
    {
        panelLayout.putConstraint(SpringLayout.NORTH, sickoButton, 12, SpringLayout.NORTH, this);
        panelLayout.putConstraint(SpringLayout.WEST, sickoButton, 480, SpringLayout.WEST, this);
    ...
    private void setupListeners()
    {
        ...
        sickoButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent mouseClick)
            {
                if (!controller.getMode().equals("NORMAL")) controller.setMode("SICKO");
                else controller.setMode("SICKO");
            }
        });
